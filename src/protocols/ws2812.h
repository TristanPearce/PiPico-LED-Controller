...
static inline void ws2812_program_init(PIO pio, uint state_machine, uint offset, uint pin, WS2812BFrequency freq, WS2812BColourFormat colourFormat) 
{
...
static int ws2812_transfer(PIO pio, uint state_machine, void* sourceAddress, size_t nofBytes) {
